...
enum class GlobalErrorCode constructor(
	...
	POST_NOT_AUTHOR(HttpStatus.FORBIDDEN, 1005, "게시글 작성자가 아닙니다."),
	...
	NOT_SUPPORT_TYPE(HttpStatus.BAD_REQUEST, 7002, "지원하지 않는 추천 타입 입니다."),
	VOTER_NOT_FOUND(HttpStatus.BAD_REQUEST, 7003, "추천이 존재하지 않습니다."),
