...
public class PostConverter {
    ...
    public static RecruitmentPostResponse toPostResponse(RecruitmentPost post, boolean isAuthor,
        ...
        return RecruitmentPostResponse.builder()
                ...
                .createdAt(post.getCreatedAt()) // 생성일
                .numOfApplicants(
                        post.getNumOfApplicants() != null ? post.getNumOfApplicants()
                                : null) // 모집 인원
                .recruitmentStatus(
                        post.getRecruitmentStatus() != null ? post.getRecruitmentStatus()
                                : null) // 모집 상태
